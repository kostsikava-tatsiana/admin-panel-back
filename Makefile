...
- Seed all: make seed
- Undo seeds: make seed-undo

The included seeder (seeders/20250903-seed-users-and-roles.js) creates roles Admin, Editor, Viewer, users alice@example.com, eddie@example.com, vera@example.com, and links them via user_roles.

### Local development (optional)

If you prefer to run without Docker and have Postgres available locally, you can start the server with auto-sync enabled:
